...
function setLang(lang){var ps=lang==='ps';document.documentElement.lang=ps?'ps':'en';document.documentElement.dir=ps?'rtl':'ltr';document.body.dir=ps?'rtl':'ltr';document.body.classList.toggle('lang-ps',ps);try{localStorage.setItem('psoli-lang',lang);}catch(e){}
...
try{if(localStorage.getItem('psoli-lang')==='ps'){setLang('ps');}}catch(e){}
